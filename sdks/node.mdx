...
| ---------- | ------ | ------------------------------------------------------- |
| `apiKey`   | string | The API Key for your Org. [details](- [Create an API Key](/misc-get-keys) for [Authentication](/api-reference/introduction#authentication).   |
| `clientId` | string | The Client ID for your Org. [details](- [Create an API Key](/misc-get-keys) for [Authentication](/api-reference/introduction#authentication). |
