...
Simply add memory to your session by calling the [Add Session Memory](/api-reference/memory/post-memory) endpoint. This will add the memory to your session, and then index it into our database.

### Get Session Memory

Simply get memory from your session by calling the [Get Session Memory](/api-reference/memory/get-memory) endpoint. This will return the memory from your session.
...
| Term | Definition |
| --- | --- |
| Context | A auto-generated sumamry of previous historical interactions |
