...
description: "This endpoint updates and replaces an existing Document(embedding) with the inputted data."
---
...
<ParamField body="id" type="string">
  Identifier for the embedding you wish to replace. Must be between 3 - 256 chars and consist of
  numbers, letters, or `-`.
</ParamField>
