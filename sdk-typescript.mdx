...
| Param      | Type   | Description                                                         |
| ---------- | ------ | ------------------------------------------------------------------- |
| `apiKey`   | string | For Managed. The API Key for your Org. [details](/authentication).  |
| `clientId` | string | For Managed.The Client ID for your Org. [details](/authentication). |
