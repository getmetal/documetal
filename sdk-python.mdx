...
<Note>You'll need an [API Key](- [Create an API Key](/misc-get-keys) for [Authentication](/api-reference/introduction#authentication) to use the SDK.</Note>
## Installation
...
| ----------- | ------ | ------------------------------------------------------- |
| `api_key`   | string | The API Key for your Org. [details](- [Create an API Key](/misc-get-keys) for [Authentication](/api-reference/introduction#authentication).   |
| `client_id` | string | The Client ID for your Org. [details](- [Create an API Key](/misc-get-keys) for [Authentication](/api-reference/introduction#authentication). |
...
```python
results = metal.search({ "text": "term-to-search", "filters": [{"field": "band", "value": "Black Sabbath"}] }, index_id="index1", limit=10)
```
